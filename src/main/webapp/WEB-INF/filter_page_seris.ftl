                ...
                <div id="feed">
                    <div class="filter-bar">
                        ...
                        <div id="fadeable">
                            <ul class="filters">
                                <li class="seris_li1">
                                    <a href="/filter/page/book/1.html">图书 (${obj.pagescount3})</a>
                                </li>
                                <li class="seris_li2">
                                    <a class="active" href="/filter/page/seris/1.html">教程 (${obj.pagescount2})</a>
                                </li>
                                <li class="seris_li3">
                            ...
                            <li class="li_index">
                                ...
                                <h3>
                                    <a class="page_title" target="_blank"
                                       href="/seris/${value._id}/${value._seristitleen}.html"> ${value._seristitle}</a>
